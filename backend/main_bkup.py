...
from validations import ProcessDataParams,EmbeddingParams,PcaParams,VisualizationInput,VarVisualizationInput
...
@app.get("/backend/download_dea_results/{uuid}", tags=["Main App"])
...
@app.post("/backend/pdf_report/", tags=["Main App"])
...
@app.post("/backend/var_names", tags=["Main App"])
...
@app.post("/backend/var_visualization/", tags=["Main App"])
